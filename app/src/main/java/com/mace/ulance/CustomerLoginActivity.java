    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firebaseAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ref = FirebaseDatabase.getInstance().getReference().child("Users").child("Customers").child(user.getUid());
                    if(ref!=null){
        ...
        nregistration.setOnClickListener(new View.OnClickListener() {
                                             ...
                                             public void onClick(View view) {
                                                 Intent intent = new Intent(CustomerLoginActivity.this, OTPcust.class);
                                                 startActivity(intent);
